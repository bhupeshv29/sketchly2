  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-40 right-10 w-72 h-72 bg-secondary/10 rounded-full mix-blend-multiply filter blur-xl animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute bottom-20 left-1/2 w-72 h-72 bg-accent/10 rounded-full mix-blend-multiply filter blur-xl animate-float"
      ...
      <div className="container relative flex flex-col items-center text-center gap-8">
        <div className="space-y-4">
          <h1 className="heading-xl">
            Where Ideas Take
            <span className="text-gradient ml-4">Shape</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-[600px] mx-auto">
            Transform your creative vision into reality with our intuitive
            digital canvas. Sketch, collaborate, and bring ideas to life in
            real-time.
          </p>
        </div>
        ...
        <div className="relative w-full max-w-[1200px] mt-16">
          ...
          <div
            className="absolute -top-4 -right-4 w-24 h-24 bg-secondary/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse-slow"
            style={{ animationDelay: "2s" }}
          />
        </div>
      </div>
